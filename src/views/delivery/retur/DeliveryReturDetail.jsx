                    ...
                    <div className="card-body">
                        <div className="d-flex justify-content-between align-items-center">
                            <div style={{lineHeight: '60%'}}>
                                <h3>RETUR PENGIRIMAN TR.RTR.001</h3>
                                <span>Detail Retur Pengiriman</span>
                            </div>
                            <div>
                    ...
                    <div className="card-body">
                        <div className="table-responsive mb-3">
                            <table className="table table-borderless align-middle" style={{minWidth: '100%'}}>
                                <tbody>
                                    <tr>
                                        <th>Kode Retur Pengiriman</th>
                                        <td>: TRP.001</td>
                                        <th>Nama Mitra</th>
                                        <td>: Ahmad Bejo</td>
                                    </tr>
                                    <tr>
                                        <th>Tanggal Retur Pengiriman</th>
...
export default DeliveryReturDetail
