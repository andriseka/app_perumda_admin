...
import { getOpnameByStatusPelaksanaan, getOpnameByStatusValidasi } from '../../../models/opname/opname_m';
...
const OpnameData = () => {
    ...
    const onDetail = (code) => {
        return navigate(`/${username}/warehouse/opname/form/${code}`)
    }
                                            ...
                                            <tr key={data.no}>
                                                ...
                                                <td>
                                                    <div className="d-flex justify-content-center">
                                                        <Button onClick={() => onDetail(data.code)} size="small" variant="contained" color={data.validasi === 'iya' ? 'primary' : 'primary'} sx={{mr: 2}}>
                                                            { data.validasi === 'iya' ? 'Opname' : 'validasi' }
                                                        </Button>
                                                    </div>
                                                </td>
                                            </tr>
